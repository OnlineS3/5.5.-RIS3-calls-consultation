	  ...
	  <br/>
          <div className="posts-list">
            ...
            <div className="col posts-list-content">
              ...
              {results.filter(post =>{ if(post.group) {return currentUser.groups.indexOf(post.group) > -1;} else {return true;} }).map(post => <Components.PostsItem post={post} key={post._id} currentUser={currentUser} terms={terms}/>)}
