  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <div className="category-menu-item category-menu-item-all">
          ...
          </div>
          {
            ...
            : <div><MenuItem><Components.Loading/></MenuItem></div>
          }
          <Components.ShowIf check={Categories.options.mutations.new.check}>
            <div className="categories-new-button category-menu-item">
